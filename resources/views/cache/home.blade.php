            ...
            <div class="row row-bottom-padded-sm">
                <div class="col-md-3">
                    <div class="fh5co-service text-center">
                        <span class=""><img src="images/ico_chisiamo.png"> </span>
                        <h3>Chi siamo</h3>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="fh5co-service text-center">
                        <span class=""><img src="images/ico_cosafacciamo.png"> </span>
                        <h3>Cosa facciamo</h3>
                ...
                <div class="col-md-3">
                    <div class="fh5co-service text-center">
                        <span class=""><img src="images/ico_formfinanz.png"> </span>
                        <h3>Gli strumenti</h3>
                ...
                <div class="col-md-3">
                    <div class="fh5co-service text-center">
                        <span class=""><img src="images/ico_glistrumenti.png"> </span>
            ...
            <div class="row row-bottom-padded-sm">
                ...
                <div class="col-md-6 padded-top">
                    ...
                    <ul class="ul_style_1">
                        ...
                        <li>White Dove Biz, studio di professionisti impegnati nella formazione comportamentale</li>
                    </ul>
            ...
            <div class="row row-bottom-padded-sm">
                <div class="col-md-4">
                    <div class="fh5co-service text-center">
                        ...
                        <h3>Differenza</h3>
                        <p>Abbiamo esperienze e competenze disparate. Questo ci aiuta ad affrontare i temi complessi del lavoro facendo della differenza un valore aggiunto.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="fh5co-service text-center">
                ...
                <div class="col-md-4">
                    <div class="fh5co-service text-center">
                        ...
                        <p>Siamo convinti che cooperare sia la migliore strategia per raggiungere importanti traguardi. </p>
                    </div>
                </div>
            </div>
